...
export default function RootLayout() {
  return (
    <main className="grid grid-cols-12 grid-rows-6">
      {/* Sidebar */}
      <nav className="sticky top-0 max-h-screen row-span-6 col-start-1 col-span-2 lg:col-span-1 xl:col-start-3 xl:col-span-2 py-4 flex flex-col justify-between items-center lg:items-stretch px-0 sm:px-3 h-full border-r border-neutral-800 ">
        <div>
